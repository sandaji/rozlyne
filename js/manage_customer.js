function deleteCustomer(id) {
  ...
  if (confirmation) {
    ...
    xhttp.open(
      "GET",
      "includes/manage_customer.php?action=delete&id=" + id,
      true
    );
    xhttp.send();
  }
...
function editCustomer(id) {
  ...
  xhttp.open("GET", "includes/manage_customer.php?action=edit&id=" + id, true);
  xhttp.send();
}
...
function updateCustomer(id) {
  ...
  if (!validateName(customer_name.value, "name_error")) customer_name.focus();
    ...
    xhttp.open(
      "GET",
      "includes/manage_customer.php?action=update&id=" +
        id +
        "&name=" +
        customer_name.value +
        "&contact_number=" +
...
function cancel() {
  ...
  xhttp.open("GET", "includes/manage_customer.php?action=cancel", true);
  xhttp.send();
}
...
function searchCustomer(text) {
  ...
  xhttp.open(
    "GET",
    "includes/manage_customer.php?action=search&text=" + text,
    true
  );
  xhttp.send();
}
