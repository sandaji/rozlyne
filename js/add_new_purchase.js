...
function addRow() {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_purchase.php?action=add_row&row_id=" +
      id.value +
      "&row_number=" +
      addRow.counter,
    true
...
function isSupplier(name) {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_purchase.php?action=is_supplier&name=" + name,
    false
  );
  xhttp.send();
...
function checkInvoice(invoice_number, error) {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_purchase.php?action=is_invoice&invoice_number=" +
      invoice_number,
    false
  );
  xhttp.send();
...
function isNewMedicine(name, packing) {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_purchase.php?action=is_new_medicine&name=" +
      name +
      "&packing=" +
      packing,
    false
...
function addNewMedicine(name, packing, generic_name, supplier_name) {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_medicine.php?name=" +
      name +
      "&packing=" +
      packing +
      "&generic_name=" +
...
function addMedicineStock(
  ...
  xhttp.open(
    "GET",
    "includes/add_new_purchase.php?action=add_stock&name=" +
      name +
      "&batch_id=" +
      batch_id +
      "&expiry_date=" +
...
function addNewPurchase(
  ...
  xhttp.open(
    "GET",
    "includes/add_new_purchase.php?action=add_new_purchase&suppliers_name=" +
      suppliers_name +
      "&invoice_number=" +
      invoice_number +
      "&payment_type=" +
