function deleteMedicine(id) {
  ...
  if (confirmation) {
    ...
    xhttp.open(
      "GET",
      "includes/manage_medicine.php?action=delete&id=" + id,
      true
    );
    xhttp.send();
  }
...
function editMedicine(id) {
  ...
  xhttp.open("GET", "includes/manage_medicine.php?action=edit&id=" + id, true);
  xhttp.send();
}
...
function updateMedicine(id) {
  ...
  if (!notNull(medicine_name.value, "medicine_name_error"))
    ...
    xhttp.open(
      "GET", "includes/manage_medicine.php?action=update&id=" +
        id +
        "&name=" +
        medicine_name.value +
        "&packing=" +
...
function cancel() {
  ...
  xhttp.open("GET", "includes/manage_medicine.php?action=cancel", true);
  xhttp.send();
}
...
function searchMedicine(text, tag) {
  ...
  xhttp.open(
    "GET",
    "includes/manage_medicine.php?action=search&text=" + text + "&tag=" + tag,
    true
  );
  xhttp.send();
}
