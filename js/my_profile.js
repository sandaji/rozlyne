...
function updateAdminDetails() {
  var pharmacy_name = document.getElementById("pharmacyName");
  var address = document.getElementById("address");
  var email = ocument.getElementById("email");
  var contact_number = document.getElementById("contactNumber");
  ...
  if (!validateName(pharmacy_name.value, "pharmacy_name_error"))
    ...
    if (validatePassword(password)) {
      ...
      xhttp.open(
        "GET",
        "includes/validateCredentials.php?action=update_admin_info&pharmacy_name=" +
          pharmacy_name.value +
          "&address=" +
          address.value +
          "&email=" +
...
function validatePassword(password) {
  ...
  xhttp.open(
    "GET",
    "includes//validateCredentials.php?action=validate_password&password=" +
      password,
    false
  );
  xhttp.send();
...
function changePassword() {
  ...
  if (!checkAdminPassword(old_password.value, "old_password_error"))
    ...
    xhttp.open(
      "GET",
      "includes//validateCredentials.php?action=change_password&password=" +
        password.value,
      false
    );
    xhttp.send();
