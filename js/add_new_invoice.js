...
function addRow() {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_invoice.php?action=add_row&row_id=" +
      cls.value +
      "&row_number=" +
      addRow.counter,
    true
...
function getInvoiceNumber() {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_invoice.php?action=current_invoice_number",
    true
  );
  xhttp.send();
}
...
function medicineOptions(text, id) {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_invoice.php?action=medicine_list&text=" + text.trim(),
    true
  );
  xhttp.send();
}
...
function fill(name, field_name, column) {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_invoice.php?action=fill&name=" +
      name +
      "&column=" +
      column,
    false
...
function checkAvailableQuantity(value, id) {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_invoice.php?action=check_quantity&medicine_name=" +
      medicine_name,
    false
  );
  xhttp.send();
...
function isCustomer(name, contact_number) {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_invoice.php?action=is_customer&name=" +
      name +
      "&contact_number=" +
      contact_number,
    false
...
function isInvoiceExist(invoice_number) {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_invoice.php?action=is_invoice&invoice_number=" +
      invoice_number,
    false
  );
  xhttp.send();
...
function isMedicine(name) {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_invoice.php?action=is_medicine&name=" + name,
    false
  );
  xhttp.send();
  //alert(xhttp.responseText);
...
function updateStock(name, batch_id, quantity) {
  ...
  xhttp.open(
    "GET",
    "includes/add_new_invoice.php?action=update_stock&name=" +
      name +
      "&batch_id=" +
      batch_id +
      "&quantity=" +
...
function addSale(
  ...
  xhttp.open(
    "GET",
    "includes/add_new_invoice.php?action=add_sale&customers_name=" +
      customers_name +
      "&customers_contact_number=" +
      customers_contact_number +
      "&invoice_number=" +
...
function addNewInvoice(
  ...
  xhttp.open(
    "GET",
    "includes/add_new_invoice.php?action=add_new_invoice&customers_name=" +
      customers_name +
      "&customers_contact_number=" +
      customers_contact_number +
      "&invoice_date=" +
