        ...
        <div class="card-body">
          ...
          <?php include('error.php'); ?>
            <div class="logo">
        			...
        			<h1 class="logo__caption">Login</h1>
        		</div> <!-- logo class -->
            ...
            <div class="form-group">
              <button class="btn btn-default btn-block btn-custom" name="login_user" >Login</button>
            </div>
          </form><!-- form close -->
      ...
      <div id="forgot-password-form" class="card m-auto p-2" style="display: none;">
        <div class="card-body">
          <div name="login-form" class="login-form">
            <div class="logo">
              <img src="images/prof.jpg" class="profile"/>
              <h1 class="logo__caption"><span class="tweak">F</span>orget <span class="tweak">P</span>assword</h1>
            </div> <!-- logo class -->
            ...
            <div id="username-password-fields" style="display: none;">
              ...
              <code class="text-light small fw-bold float-right mb-2" id="username_error" style="display: none;"></code>
              ...
              <code class="text-light small fw-bold float-right mb-2" id="password_error" style="display: none;"></code>
              ...
              <code class="text-light small fw-bold float-right mb-2" id="confirm_password_error" style="display: none;"></code>
              <div class="form-group">
